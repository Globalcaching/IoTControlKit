...
{
    public class SettingsDatabase : NPoco.Database
    {
        private BaseDatabaseService _service;

        public SettingsDatabase(BaseDatabaseService service, DbConnection connection) : base(connection, NPoco.DatabaseType.SQLite)
        {
            _service = service;
